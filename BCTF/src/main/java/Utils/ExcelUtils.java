...
public class ExcelUtils {
	...
	public static Object[][] getExcelData(String filename, String sheetname) throws IOException {
		...
		FileInputStream fileInputStream = new FileInputStream(filename); // Excel
																			// sheet
																			// file
																			// location
																			// get
																			// mentioned
																			// here
		XSSFWorkbook workbook = new XSSFWorkbook(fileInputStream); // get my
																	// workbook
		XSSFSheet worksheet = workbook.getSheet(sheetname);// get my sheet from
															// workbook
